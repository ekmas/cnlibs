// The 8bit/ui theme registry: each entry here is the canonical source for
// one installable theme. This same data feeds three things:
//   1. The live preview on /theme (ThemePreview, ThemePresetSelect, ThemePresetSync)
...
//
// Field shape mirrors shadcn's registry-item cssVars convention directly
// (theme/light/dark buckets) so compiling an entry into a registry item is a
// near-identity transform. No external registry (e.g. tweakcn) is consulted
// at runtime or at build time.
//
// chart-1..5 (used by dither-kit charts, see components/dither-kit/palette.ts)
// come straight from tweakcn's real registry — the 19 core tokens above them
// were hand-approximated for the in-app preview and don't cover chart
// colours, so those still need a one-time fetch per theme if this file is
...
export const THEMES: ThemeRegistryEntry[] = [
  {
    slug: "default",
    title: "Default (8bit)",
    description: "The base 8bit/ui theme — ships with every install.",
    cssVars: {
      theme: {
        radius: "0.5rem",
      },
  ...
  },
  {
    slug: "claymorphism",
    title: "Claymorphism",
    description: "Claymorphism theme.",
    cssVars: {
      theme: {
        radius: "1.25rem",
      },
  ...
  },
  {
    slug: "pastel-dreams",
    title: "Pastel Dreams",
    description: "Pastel Dreams theme.",
    cssVars: {
      theme: {
        radius: "1.5rem",
      },
  ...
  },
  {
    slug: "retro-arcade",
    title: "Retro Arcade",
    description: "Retro Arcade theme.",
    cssVars: {
      theme: {
        radius: "0.25rem",
      },
...
/** Every color token a theme sets — shared across all themes above. */
export const THEME_COLOR_KEYS = Object.keys(THEMES.at(0)?.cssVars.light ?? {});
