...
export function PolarRoot<TData extends Row>({
  ...
  // Forces a re-render once the real (theme-resolved) dither colours are
  // ready — see palette.ts. Reading the snapshot itself isn't needed here;
  // subscribing is what matters, since seedOfColor() re-reads the module
  // cache directly wherever it's called during the render this triggers.
  useSyncExternalStore(
    subscribeDitherPalette,
    getDitherPaletteSnapshot,
    getDitherPaletteSnapshot
