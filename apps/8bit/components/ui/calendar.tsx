...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-radius:0px] [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) [--px-border-color:transparent] p-0 select-none aria-disabled:opacity-50",
